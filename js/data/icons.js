...
const Icons = {
  // Toolbar icons
  select: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 3l7.07 16.97 2.51-7.39 7.39-2.51L3 3z"/></svg>`,
  ...
  duplicate: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z"/></svg>`,
  
  delete: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z"/></svg>`,
  ...
  unlock: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18,20V10H6V20H18M18,8A2,2 0 0,1 20,10V20A2,2 0 0,1 18,22H6C4.89,22 4,21.1 4,20V10A2,2 0 0,1 6,8H15V6A3,3 0 0,0 12,3A3,3 0 0,0 9,6H7A5,5 0 0,1 12,1A5,5 0 0,1 17,6V8H18M12,17A2,2 0 0,1 10,15A2,2 0 0,1 12,13A2,2 0 0,1 14,15A2,2 0 0,1 12,17Z"/></svg>`,
  ...
  export: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M23,12L19,8V11H10V13H19V16M1,18V6C1,4.89 1.89,4 3,4H15A2,2 0 0,1 17,6V9H15V6H3V18H15V15H17V18A2,2 0 0,1 15,20H3A2,2 0 0,1 1,18Z"/></svg>`,
  
  magnifier: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M15.5,14L20.5,19L19,20.5L14,15.5V14.71L13.73,14.43C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.43,13.73L14.71,14H15.5M9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14M12,10H10V12H9V10H7V9H9V7H10V9H12V10Z"/></svg>`,
  
  ruler: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M1.39,18.36L3.16,16.6L4.58,18L5.64,16.95L4.22,15.54L5.64,14.12L8.11,16.6L9.17,15.54L6.7,13.06L8.11,11.65L9.53,13.06L10.59,12L9.17,10.59L10.59,9.17L13.06,11.65L14.12,10.59L11.65,8.11L13.06,6.7L14.47,8.11L15.54,7.05L14.12,5.64L15.54,4.22L18,6.7L19.07,5.64L16.6,3.16L18.36,1.39L22.61,5.64L5.64,22.61L1.39,18.36Z"/></svg>`,
  ...
  alignLeft: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4,22H2V2H4V22M22,7H6V10H22V7M16,14H6V17H16V14Z"/></svg>`,
  
  alignRight: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20,2H22V22H20V2M2,10H18V7H2V10M8,17H18V14H8V17Z"/></svg>`,
  
  alignCenter: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11,2H13V7H21V10H13V14H18V17H13V22H11V17H6V14H11V10H3V7H11V2Z"/></svg>`,
  
  alignTop: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M22,2V4H2V2H22M7,22H10V6H7V22M14,16H17V6H14V16Z"/></svg>`,
  
  alignBottom: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M22,22H2V20H22V22M10,2H7V18H10V2M17,8H14V18H17V8Z"/></svg>`,
  
  alignMiddle: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M22,11H18V6H14V11H10V3H6V11H2V13H6V21H10V13H14V18H18V13H22V11Z"/></svg>`,
  
  bringFront: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2,2H11V11H2V2M9,4H4V9H9V4M22,13V22H13V13H22M15,15V20H20V15H15M16,8V11H13V8H16M11,16H8V13H11V16Z"/></svg>`,
  
  sendBack: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2,2H11V6H9V4H4V9H6V11H2V2M22,13V22H13V18H15V20H20V15H18V13H22M8,8H16V16H8V8Z"/></svg>`,
  
  group: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2,6V8H14V6H2M2,10V12H14V10H2M20.59,11.93L16.66,16.07L14.5,13.71L13,15.29L16.66,19.21L22,13.54L20.59,11.93M2,14V16H11V14H2Z"/></svg>`,
  
  ungroup: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2,6V8H14V6H2M2,10V12H14V10H2M2,14V16H14V14H2M17,10V14H13V16H17V20H19V16H23V14H19V10H17Z"/></svg>`,
  
  zoomIn: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M15.5,14H14.71L14.43,13.73C15.41,12.59 16,11.11 16,9.5A6.5,6.5 0 0,0 9.5,3A6.5,6.5 0 0,0 3,9.5A6.5,6.5 0 0,0 9.5,16C11.11,16 12.59,15.41 13.73,14.43L14,14.71V15.5L19,20.5L20.5,19L15.5,14M9.5,14C7,14 5,12 5,9.5C5,7 7,5 9.5,5C12,5 14,7 14,9.5C14,12 12,14 9.5,14M12,10H10V12H9V10H7V9H9V7H10V9H12V10Z"/></svg>`,
  
  zoomOut: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M15.5,14H14.71L14.43,13.73C15.41,12.59 16,11.11 16,9.5A6.5,6.5 0 0,0 9.5,3A6.5,6.5 0 0,0 3,9.5A6.5,6.5 0 0,0 9.5,16C11.11,16 12.59,15.41 13.73,14.43L14,14.71V15.5L19,20.5L20.5,19L15.5,14M9.5,14C7,14 5,12 5,9.5C5,7 7,5 9.5,5C12,5 14,7 14,9.5C14,12 12,14 9.5,14M7,9H12V10H7V9Z"/></svg>`,
  
  fullscreen: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M5,5H10V7H7V10H5V5M14,5H19V10H17V7H14V5M17,14H19V19H14V17H17V14M10,17V19H5V14H7V17H10Z"/></svg>`,
